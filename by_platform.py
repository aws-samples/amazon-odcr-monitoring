...
file_handler = logging.FileHandler('by_platform.log')
...
# creates an alarm for InstanceUtilization CW metric with by_platform dimension and if SNS topic not created in a region, it will create one.
def createCWAlarm(topic_name,Dimension,MetricName,RegionName,EmailAddress,Protocol,ComparisonOperator,Threshold,InstancePlatform):
    ...
    response = cw.put_metric_alarm(
        AlarmName=f'ODCRAlarm-{MetricName}-{Dimension}-{InstancePlatform}',
        AlarmActions=[
        topic_arn,
        ],
...
def main():
    ...
    parser.add_argument(
        ...
        type=str, 
        default='Platform', 
        help="The dimension for the CloudWatch alarm. Default is 'Platform'."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,  # This makes the argument required
        help="The InstancePlatform for the CloudWatch alarm. Example: 'Linux/UNIX'. Supported InstancePlatform are'Linux/UNIX','Red Hat Enterprise Linux','SUSE Linux','Windows','Windows with SQL Server','Windows with SQL Server Enterprise','Windows with SQL Server Standard','Windows with SQL Server Web','Linux with SQL Server Standard','Linux with SQL Server Web','Linux with SQL Server Enterprise','RHEL with SQL Server Standard','RHEL with SQL Server Enterprise','RHEL with SQL Server Web','RHEL with HA','RHEL with HA and SQL Server Standard','RHEL with HA and SQL Server Enterprise','Ubuntu Pro' " 
    )
    parser.add_argument(
        '--TopicName',
        type=str,
    ...
    createCWAlarm(topicName, dimension, metricName, regionName, emailAddress, protocol, comparisonOperator, threshold, InstancePlatform)  
